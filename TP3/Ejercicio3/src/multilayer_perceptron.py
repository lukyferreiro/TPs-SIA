...
class MultilayerPerceptron:
    ...
    def predict(self):
        O, _ = self.__forward_propagation(self)
        return O, _
    ...
    def __backward_propagation(self, O, caches):
        ...
        for l in reversed(range(L-1)):
            ...
            gradients['dV'+str(l)], gradients['dW'+str(l+1)], gradients['db'+str(l+1)] = self.__activation_backward(gradients['dV'+str(l+1)], current_cache, self.hidden_activation)
    ...
    def __activation_backward(self, dV, cache, activation):
        ...
        switcher = {
            "TANH": self.__activate_backward_tanh(dV, activation_cache),
    ...
    def __activate_backward_tanh(self, dV, cache):
        H = cache
