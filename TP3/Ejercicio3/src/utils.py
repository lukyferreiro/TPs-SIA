...
def destructure_data(data):
   ...
   qty_hidden_layers = check_arr(data['qty_hidden_layers'], "cantidad de capas ocultas")
   qty_nodes_in_hidden_layers = check_arr(data['qty_nodes_in_hidden_layers'], "cantidad de nodos en capas ocultas")

   if(len(qty_hidden_layers) != len(qty_nodes_in_hidden_layers)):
   ...
   hidden_activation = check_type(data['hidden_layers']['activation'], data['activation_options'], "funcion de activacion de capas ocultas")
