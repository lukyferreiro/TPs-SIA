...
from src.stochastic_layer import StochasticLayer
...
class VariationalAutoencoder:
    def __init__(self, input_data, expected_data, latent_space_size, learning_rate, bias, epochs, training_percentage, min_error,
        ...
        self.layers, self.latent_space_idx, self.stochastic_layer = self.__init_layers()  # Inicialización de las capas
    ...
    def __init_layers(self):
        ...
        return layers, latent_space_idx, stochastic_layer
    ...
    def latent_space(self, init_input):
        ...
        return self.stochastic_layer.activate(activations[-1])
